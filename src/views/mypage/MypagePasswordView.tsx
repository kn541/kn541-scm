...
/**
 * KN541 SCM 비밀번호 변경
 * POST /mypage/change-password (백엔드 실제 스펙: current_password, new_password, confirm_password)
 */
...
export default function MypagePasswordView() {
  ...
  const handleSave = async () => {
    ...
    setSaving(true)
    try {
      await scmPost<{ message?: string }>('/mypage/change-password', {
          ...
          <Grid container spacing={3}>
            ...
            <Grid size={12}>
              <CustomTextField
                ...
                slotProps={{ input: { endAdornment: <EyeBtn field='next' /> } }}
              />
            </Grid>
            <Grid size={12}>
              <CustomTextField
                ...
                slotProps={{ input: { endAdornment: <EyeBtn field='confirm' /> } }}
              />
            </Grid>
          </Grid>
          <Box sx={{ mt: 3 }}>
